...
import { baseURL, period_listURL } from '../../config/AppData'
import axios from 'axios'
import TableLoader from '../../components/TableLoader'
const Periods = ({ icon, name }) => {
        ...
        <div className="row data-op-row">
          ...
          <span className='col-md-6 data-op'>
            <div className="row justify-content-evenly align-items-center">
              ...
              <div className="col-6 ">
                <Link to={_routes.app.urls.add_period} className="btn btn-primary ">
                  <AddCircleOutline /> Add Period
                </Link>
              </div>
            </div>
          </span>
